    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted', models.BooleanField(default=False, help_text='If False - author is active. If True - author is no longer available', verbose_name='Is Deleted')),
                ('rating', models.IntegerField(default=1, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(10)], verbose_name='Author Rating')),
            ],
        ),
        migrations.CreateModel(
            name='Category',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.CharField(choices=[('Fiction', 'Fiction'), ('Non-Fiction', 'Non-Fiction'), ('Science Fiction', 'Science Fiction'), ('Fantasy', 'Fantasy'), ('Mystery', 'Mystery'), ('Biography', 'Biography')], max_length=50, null=True, verbose_name='Genre')),
                ('page_count', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MaxValueValidator(10000)], verbose_name='Page Count')),
                ...
                ('publisher', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='library.publisher', verbose_name='Publisher')),
            ],
            options={
                'verbose_name': 'Book',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age', models.IntegerField(validators=[django.core.validators.MinValueValidator(6), django.core.validators.MaxValueValidator(120)], verbose_name='Age')),
                ('role', models.CharField(choices=[('Admin', 'Admin'), ('Staff', 'Staff'), ('Reader', 'Reader')], max_length=20, verbose_name='Role')),
                ('active', models.BooleanField(default=True, verbose_name='Active')),
                ('libraries', models.ManyToManyField(related_name='members', to='library.library', verbose_name='Libraries')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='posts', to='library.member', verbose_name='Author')),
